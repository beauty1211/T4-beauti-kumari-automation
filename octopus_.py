...
driver.find_element(By.XPATH, "//input[@placeholder='Enter generator name']").send_keys("beauti")
driver.find_element(By.XPATH, "//input[@placeholder='Enter internal account number']").send_keys("98765432112345")
...
driver.find_element(By.ID, "serviceAddress-street").send_keys("sector V")
...
driver.find_element(By.XPATH, "//input[@placeholder='ZIP Code']").send_keys("700102")
driver.find_element(By.XPATH, "//input[@placeholder='Email Address']").send_keys("beauti@gmail.com")
driver.find_element(By.XPATH, "//input[@placeholder='(123) 456-7890']").send_keys("9263396645")
#latitude & longitutde
time.sleep(2)
...
driver.find_element(By.XPATH,"//button[text()='...']").click()
time.sleep(4)
driver.find_element(By.XPATH, "//button[text()='Price Book']").click()
time.sleep(2)
...
# logout
driver.find_element(By.XPATH, "(//img[contains(@class,'rounded-full')])[1]").click()
time.sleep(3)

driver.find_element(By.XPATH, "//button[contains(@class,'text-left')]").click()
